...
@section('js')
    ...
    <!-- Page level plugins -->
    <script src="/admin_resource/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="/admin_resource/js/demo/chart-area-demo.js"></script>
    <script src="/admin_resource/js/demo/chart-pie-demo.js"></script>
@endsection
