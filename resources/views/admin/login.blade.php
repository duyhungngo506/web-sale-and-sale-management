                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Quản lý bán hàng</h1>
                                    </div>
                                    <form class="user" method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @error('email')
                                                <div style="color: rgb(181, 46, 46)" class="alert alert ">
                                                    {{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                ...
                                                {{-- <label class="custom-control-label" for="customCheck">Lưu đăng
                                                    nhập</label> --}}
                                            </div>
                                        </div>
